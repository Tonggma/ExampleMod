package ton.ExampleMod.common.model;
...
public class ExampleEntityModel extends EntityModel<ExampleEntity> { //构建实体模型 工具: blockbench
    ...
    public ExampleEntityModel() {
        ...
        leftleg.setTextureOffset(44, 48).addBox(-5.0F, -6.0F, -5.0F, 4.0F, 6.0F, 12.0F, 0.0F, false);

        rightleg = new ModelRenderer(this);
        rightleg.setRotationPoint(0.0F, 24.0F, 0.0F);
        rightleg.setTextureOffset(54, 0).addBox(1.0F, -6.0F, -5.0F, 4.0F, 6.0F, 12.0F, 0.0F, false);
    }
